...
const TravelJournalView: React.FC = () => {
  ...
  return (
    <WarmBg>
      ...
      <button 
        onClick={handleBack}
        className="absolute bottom-6 right-6 hover:scale-105 transition-transform duration-200"
      >
        <div className="w-16 h-12 bg-amber-100 rounded-md shadow-lg transform rotate-12 relative cursor-pointer hover:bg-amber-200 transition-colors">
